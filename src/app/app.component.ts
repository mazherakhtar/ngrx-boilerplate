...
import "rxjs";
import {ADD_TODO, REMOVE_TODO, TOGGLE_TODO, LOAD_TODOS} from './common/actions';
...
export class TodoApp {
	...
	constructor(
		...
		_store.dispatch({ type: LOAD_TODOS });
			...
			.combineLatest(
				...
				(todos : Array<Todo>, visibilityFilter : any) => {
					return {
						...
						completedTodos: todos.filter((todo : Todo) => todo.isCompleted).length
					}
				}
			);
	}
